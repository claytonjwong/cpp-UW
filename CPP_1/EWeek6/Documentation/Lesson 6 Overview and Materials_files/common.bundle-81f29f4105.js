canvasWebpackJsonp([79],{"+JpRIS14Qm":function(e,t,i){var n,a
...
var h=r.default.MepDefaults.features.indexOf("tracks")+1
r.default.MepDefaults.features.splice(h,0,"sourcechooser")
r.default.MepDefaults.features.splice(h,0,"speed")
function f(e){var t=new d.default.Deferred
...
return s.disableWhileLoading(f(e).done(function(a){if(a.sources.length){var d={can_add_captions:a.can_add_captions,mediaCommentId:e,googleAnalyticsTitle:e},u=m({sourcesAndTracks:a,mediaPlayerOptions:d,mediaType:t,height:o,width:r})
u.appendTo(s.html(""))
...
var h="180",f="50"
o.embedSWF("//"+INST.kalturaSettings.domain+"/kupload/ui_conf_id/"+INST.kalturaSettings.upload_ui_conf,"audio_upload",h,f,"9.0.0",!1,l,c)
...
var p,g,v,y,b,k,w,x
h="180",f="50"
o.embedSWF("//"+INST.kalturaSettings.domain+"/kupload/ui_conf_id/"+INST.kalturaSettings.upload_ui_conf,"video_upload",h,f,"9.0.0",!1,l,c)
var C,E
_=!0
...
n.addEntry=l}var f=new Date
f-h>3e5&&(0,s.default)("#media_comment_dialog").dialog("close").remove()
h=f
...
e[14+(t+64>>>9<<4)]=t
for(var i=1732584193,n=-271733879,a=-1732584194,o=271733878,r=0;r<e.length;r+=16){var s=i,d=n,f=a,m=o
...
n=h(n,d)
a=h(a,f)
o=h(o,m)}return Array(i,n,a,o)}function d(e,t,i,n,a,o){return h((r=h(h(t,e),h(n,o)))<<(s=a)|r>>>32-s,i)
var r,s}function u(e,t,i,n,a,o,r){return d(t&i|~t&n,e,t,a,o,r)}function l(e,t,i,n,a,o,r){return d(t&n|i&~n,e,t,a,o,r)}function c(e,t,i,n,a,o,r){return d(t^i^n,e,t,a,o,r)}function _(e,t,i,n,a,o,r){return d(i^(t|~n),e,t,a,o,r)}function h(e,t){var i=(65535&e)+(65535&t)
...
window.ENV.NEW_USER_TUTORIALS&&window.ENV.NEW_USER_TUTORIALS.is_enabled&&window.ENV.context_asset_string&&"courses"===(0,s.default)(window.ENV.context_asset_string)[0]&&i.e(11).then(function(e){i("72sEc2o3li")()}.bind(null,i)).catch(i.oe)
!(window.navigator.userAgent.indexOf("Edge")>-1)&&window.CSS&&window.CSS.supports&&window.CSS.supports("(--foo: red)")||i.e(20).then(function(e){window.canvasCssVariablesPolyfill=i("yLhLh4Z3xO")}.bind(null,i)).catch(i.oe);(0,n.default)(function(){(0,d.isMathMLOnPage)()&&(0,d.loadMathJax)("MML_HTMLorMML.js")})},VHZX6oywWS:function(e,t,i){"use strict"
var n,a=i("mOY9BNujNR"),o=(n=a)&&n.__esModule?n:{default:n}
i("O9QjtziI9Q")
i("1YHB9uvbU1")
...
var h=o.default.ajaxJSON.findRequest(t)
if((h=h||{}).data){h.params=""
for(var f in h.data)h.params+="&"+f+"="+h.data[f]}var m=""
try{m=(0,o.default)("#identity .user_name").text()}catch(e){}if(n.default.ajaxErrorURL){var p="&Msg="+escape(l)+"&StatusCode="+escape(u)+"&URL="+escape(h.url||"unknown")+"&Page="+escape(location.href)+"&Method="+escape(h.submit_type||"unknown")+"&UserName="+escape(m)+"&Platform="+escape(navigator.platform)+"&UserAgent="+escape(navigator.userAgent)+"&Params="+escape(h.params||"unknown");(0,o.default)("body").append("<img style='position: absolute; left: -1000px; top: 0;' src='"+(0,r.default)(n.default.ajaxErrorURL+p.substring(0,2e3))+"' />")}}});(0,o.default)(".last_error_details_link").live("click",function(e){e.preventDefault()
...
//# sourceMappingURL=common.bundle-81f29f4105.js.79-81f29f4105.sourcemap